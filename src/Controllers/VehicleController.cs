...
namespace Triton.FleetManagement.Web.Controllers
{
    ...
    public class VehicleController : Controller
        ...
        [HttpGet]
        public async Task<IActionResult> AuditTrail(int vehicleID)
        {
            var bvm = new VehicleViewModel();
            bvm.VehicleAuditModelList = await VehicleService.GetVehicleAuditAsync(vehicleID);
